  ...
  return (
    <main className="relative min-h-screen w-screen overflow-hidden bg-[#faf9f6]">
      ...
      <div
        ...
        style={{
          background: "radial-gradient(circle at center, rgba(139, 0, 0, 0.3) 0%, rgba(139, 0, 0, 0) 70%)",
          filter: "blur(70px)",
      ...
      <div
        ...
        style={{
          background: "radial-gradient(circle at center, rgba(255, 99, 71, 0.4) 0%, rgba(255, 99, 71, 0) 70%)",
          filter: "blur(70px)",
        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className="space-y-8">
            ...
            <div className="space-y-4">
              ...
              <a href="mailto:jessica@socrateslabs.io" className="text-red-600 hover:text-red-700 font-medium">
                jessica@socrateslabs.io
              </a>
            </div>
          </div>
        </div>
